...
class Matrix{
	...
	function __construct(array $kwargs){
		if (array_key_exists('preset', $kwargs))
		{
			...
			// 	return ($this->matrix);
			if ($preset == Matrix::REVERSE)
			{
				$o = $kwargs['ma'];
				$this->matrix = $o;
				// $this->matrix =  array( "a" => array('1' => $o->geta1(), '2'=> $o->geta2(), '3'=> $o->geta3(), '4'=> $o->geta4()), "b" =>array('1' =>$o->getb1(), '2'=>  $o->getb2(), '3'=> $o->getb3(), '4'=> $o->getb4()), "c" => array('1' =>$o->getc1(), '2'=> $o->getc2(), '3'=>  $o->gec3(), '4'=> $o->getc4()),"d" => array('1' => $o->getd1(), '2'=>  $o->getd2(), '3'=>  $o->getd3(), '4'=>  $o->getd4()));
				// $this->matrix 
			}
	...
	function mult(Matrix $rhs)
	{
		...
		// $m = $this->matrix['a']['4'] * $rhs->matrix['a']['1'] +  $this->matrix['b']['4'] * $rhs->matrix['a']['2'] +  $this->matrix['c']['4'] * $rhs->matrix['a']['3'] ;
		// $l = $this->matrix['a']['4'] * $rhs->matrix['b']['1'] +  $this->matrix['b']['4'] * $rhs->matrix['b']['2'] +  $this->matrix['c']['4'] * $rhs->matrix['b']['3'] ;
		// $n = $this->matrix['a']['4'] * $rhs->matrix['c']['1'] +  $this->matrix['b']['4'] * $rhs->matrix['c']['2'] +  $this->matrix['c']['4'] * $rhs->matrix['c']['3'] ;
		$rhs->matrix['d']['3'] *= -1;
		$this->matrix =  array( "a" => array('1' => $a, '2'=> $d, '3'=> $g, '4'=> 0), "b" =>array('1' => $b, '2'=>  $e, '3'=> $h, '4'=> 0), "c" => array('1' => $c, '2'=> $f, '3'=>  $i, '4'=> 0),"d" => $rhs->matrix['d']); 
		return ($this);
	}
	...
	function __toString(){
		...
		$str .= sprintf("w | %.2f | %.2f | %.2f | %.2f",$this->matrix['a']['4'],$this->matrix['b']['4'],$this->matrix['c']['4'],$this->matrix['d']['4']);
		return $str;
	}
	function geta1(){return $this->matrix['a']['1'];}
	function geta2(){return $this->matrix['a']['2'];}
	function geta3(){return $this->matrix['a']['3'];}
	function geta4(){return $this->matrix['a']['4'];}
	function getb1(){return $this->matrix['b']['1'];}
	function getb2(){return $this->matrix['b']['2'];}
	function getb3(){return $this->matrix['b']['3'];}
	function getb4(){return $this->matrix['b']['4'];}
	function getc1(){return $this->matrix['c']['1'];}
	function getc2(){return $this->matrix['c']['2'];}
	function getc3(){return $this->matrix['c']['3'];}
	function getc4(){return $this->matrix['c']['4'];}
	function getd1(){return $this->matrix['d']['1'];}
	function getd2(){return $this->matrix['d']['2'];}
	function getd3(){return $this->matrix['d']['3'];}
	function getd4(){return $this->matrix['d']['4'];}
}
?>